...
def get_stock_data(ticker, years):
    try:
        ...
        return df, slope, r_squared # 新增回傳 r_squared
    except: return None
...
with st.container():
    ...
    # 新增 i5: 趨勢強度 (R2)
    if r_squared > 0.8: r2_label = "💎 極穩"
    elif r_squared > 0.5: r2_label = "📈 穩定"
    else: r2_label = "☁️ 隨機"
    i5.metric("趨勢強度 (R²)", f"{r_squared:.2f}", r2_label, delta_color="off", help="數值愈高代表五線譜參考價值愈大")
